namespace :deploy302 do
  ...
  task :deploy do
    invoke "deploy302:make_release_dir"
    invoke "deploy302:upload_release_item"
    invoke "deploy302:stop_tomcat"
    invoke "deploy302:release"
    invoke "deploy302:start_tomcat"
    invoke "deploy302:check_released_dir"
  end
